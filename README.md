...
You can install this plugin from the [ZIP archive](https://drive.google.com/file/d/1h9wp7Y0UuVoAl2iGXpKM3KBvC3O-fsT1/view?usp=sharing) as any other plugin. Follow [this instruction](https://wordpress.org/support/article/managing-plugins/#upload-via-wordpress-admin).
