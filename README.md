...
You can install the plugin from this [ZIP file](https://drive.google.com/file/d/1i384-Gf-cTr4RyizCTAYTxvQq-bGwzIO/view?usp=sharing) as any other plugin. Follow [this instruction](https://wordpress.org/support/article/managing-plugins/#upload-via-wordpress-admin).
